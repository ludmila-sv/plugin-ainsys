...
class Ainsys_Html {
	...
	static function generate_debug_log() {
        ...
        !!Debug info!!
            <ul>
                <li>' . 'connector #' . Settings\Ainsys_Settings::get_option( 'connectors' ) . '</li>
                <li>' . 'handshake_url - ' . Settings\Ainsys_Settings::get_option( 'handshake_url' ) . '</li>
                <li>' . 'webhook_url - ' . Settings\Ainsys_Settings::get_option( 'webhook_url' ) . '</li>
                <li>' . 'debug_log - ' . Settings\Ainsys_Settings::get_option( 'debug_log' ) . '</li>
            </ul>
        </div>';
